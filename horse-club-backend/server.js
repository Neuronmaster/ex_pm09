...
const JWT_SECRET = 'your_jwt_secret'; // TODO: Используйте более сложный секрет для продакшн среды
...
// защищенный маршрута для получения данных пользователя
app.get('/api/user', authMiddleware, async (req, res) => {
  try {
    ...
    // Пример получения записей пользователя
    const records = []; // TODO: Замените на реальное получение записей
